...
(function ($) {
    ...
    FileInput.prototype = {
        ...
        uploadExtra: function () {
            ...
            self.formdata.append("pid", $("#pid").val());//修改过了，获取前台pid的数据
            self.formdata.append("title", $("#titleRule").val());//修改过了，获取前台titleRule的数据
            self.formdata.append("pingpai", $("#pingpai").val());
        },
        ...
        uploadSingle: function (i, files, allFiles) {
            ...
            fnSuccess = function (data, textStatus, jqXHR) {
              //  alert("pid:" + data.pid + "title:" + data.title + "img:"+ data.img);
            ...
            fnComplete = function () {
                ...
                /*自己修改*/
                $("#"+params.id).remove();
                if($(".file-preview-frame").length==0) self.reset();//文件上传成功自动清空
                /*自己修改*/
            };
