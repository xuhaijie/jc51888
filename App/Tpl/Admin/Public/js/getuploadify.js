...
{
	$("body").append('<iframe frameborder="0" id="'+ frame +'" src="uploadify/title/'+ encodeURI(title) +'/type/'+ type +'/desc/'+ encodeURI(desc) +'/num/'+ num +'/size/'+ size +'/frame/'+ frame +'/input/'+ input +'/area/'+ area +'" allowtransparency="true" class="uploadframe" scrolling="no"></iframe>');
...
function ClearPicArr(val)
{
	$("li[rel='"+ val +"']").remove();
	$.get(
		'../Public/plugin/uploadify/uploadify.php',
