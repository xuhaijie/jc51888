	...
	<?php default: endswitch;?>
	        <div class="right_main">
	        	<div class="page-header" style="text-align: center;">
				  <h3><?php echo ($list['title']); ?><br><small>发布：<?php echo ($user['username']); ?> 浏览：<?php echo ($list['click']); ?>次</small></h2>
				</div>
              <div class="list-con" style="line-height:25px;"><?php echo ($list['content']); ?></div>
