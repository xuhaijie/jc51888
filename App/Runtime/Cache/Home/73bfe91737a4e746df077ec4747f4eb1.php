						...
						<div id="allmap">
							<script>
		                        ...
		                        var infoWin = new BMap.InfoWindow(
		                        	'<div style="text-align:left;color:#1A6DAF;"><?php $__FOR_START_17207__=1;$__FOR_END_17207__=9;for($i=$__FOR_START_17207__;$i < $__FOR_END_17207__;$i+=1){ switch($i): case "1": ?><p><?php echo ($config['web_name']); ?></p><?php break;?>
