                    ...
                    <form id="form1">
                        <ul>
                            ...
                            <li>
                                ...
                                <div class="item_cont">
                                    <input type="text" class="txt required" id="str_rule" name="str_rule" style="width:332px;" value="<?php echo (cookie('str_rule')); ?>" />　<a href="javascript:;" class="rule_a">[参数]</a> 例如：http://xxxx.com/news/4_[参数]
                                </div>
                            </li>
                            <li>
                                <label for="title">循环设置：</label>
                                <div class="item_cont" id='for_content_1'>
                                从　<input type="text" class="txt required" id="str_set1" name="str_set1" style="width:130px;" value="<?php echo (cookie('str_set1')); ?>" />　到　<input type="text" class="txt required" id="str_set2" name="str_set2" style="width:130px;" value="<?php echo (cookie('str_set2')); ?>" />　<a href="javascript:;" class="for_a" rel='2'>id集合?</a>
                                </div>
                            ...
                            <li>
                                ...
                                <div class="item_cont">
                                    <input type="text" class="txt required" id="title_select" name="title_select" style="width:200px;" value="<?php echo (cookie('title_select')); ?>" /> JQ选择器,例如：$(".container")　<br><br><input type="text" class="txt required" id="title_select_order" name="title_select_order" style="width:200px;" value="<?php echo (cookie('title_select_order')); ?>" /> 若是有多项内容符合选择器条件的,设置采集项,从1开始,默认为第一项
                                </div>
                            </li>
                            <li>
                                <label for="title">图片：</label>
                                <div class="item_cont">
                                    <input type="text" class="txt required" id="img_select" name="img_select" style="width:200px;" value="<?php echo (cookie('img_select')); ?>" /> JQ选择器,例如：$(".container")　<br><br><input type="text" class="txt required" id="title_select_order" name="img_select_order" style="width:200px;" value="<?php echo (cookie('title_select_order')); ?>" /> 若是有多项内容符合选择器条件的,设置采集项,从1开始,默认为第一项
                                </div>
                            </li>
                            <li>
                                <label for="title">内容：</label>
                                <div class="item_cont">
                                    <input type="text" class="txt required" id="content_select" name="content_select" style="width:200px;" value="<?php echo (cookie('content_select')); ?>" /> JQ选择器,例如：$(".container")　<br><br><input type="text" class="txt required" id="content_select_order" name="content_select_order" style="width:200px;" value="<?php echo (cookie('content_select_order')); ?>" /> 若是有多项内容符合选择器条件的,设置采集项,从1开始,默认为第一项　<br><br><input type="text" class="txt required" id="content_select_filter" name="content_select_filter" style="width:200px;" value="a" /> 过滤标签,用空格隔开,如:a -$("span") -$("#id")<br><br><input type="checkbox" value='' id='check_content'/> 内容为空时不采集
                                </div>
                            </li>
                            <li>
                                <label for="title">时间：</label>
                                <div class="item_cont">
                                    <input type="text" class="txt required" id="time_select" name="time_select" style="width:200px;" value="<?php echo (cookie('time_select')); ?>" /> JQ选择器,例如：$(".container"),留空则为当前时间　<br><br><input type="text" class="txt required" id="time_select_order" name="time_select_order" style="width:200px;" value="<?php echo (cookie('time_select_order')); ?>" /> 若是有多项内容符合选择器条件的,设置采集项,从1开始,默认为第一项
                                </div>
                            </li>
                            <li class="push">
                                <div class="item_cont">
