...
(function($){$.fn.jCarouselLite=function(o){
 ...
 return this.each(function(){
  ...
  if(o.circular){
   ...
   o.start+=v}var f=$("li",ul),itemLength=f.size(),curr=o.start;c.css("visibility","visible");
   f.css({overflow:"hidden",float:o.vertical?"none":"left"});
   ul.css({margin:"0",padding:"0",position:"relative","list-style-type":"none","z-index":"1"});
   c.css({overflow:"hidden",position:"relative","z-index":"2",left:"0px"});
   var g=o.vertical?height(f):width(f);var h=g*itemLength;
   var j=g*v;f.css({width:f.width(),height:f.height()});
   ul.css(sizeCss,h+"px").css(animCss,-(curr*g));
   c.css(sizeCss,j+"px");
   if(o.btnPrev)$(o.btnPrev).hover(function(){o.play=false;},function(){o.play=true;});
   if(o.btnNext)$(o.btnNext).hover(function(){o.play=false;},function(){o.play=true;});
